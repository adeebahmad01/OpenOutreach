...
Both kinds send from your mailbox under your identity, and both are your responsibility under anti-spam law. The freemium promotion has been part of the project since the beginning. On an install you run yourself it can be disabled by editing the source (the GPLv3 licence permits this). Full detail — the fraction, the content source, and your responsibilities — is in the **[Legal Notice](LEGAL_NOTICE.md)** (§4).
